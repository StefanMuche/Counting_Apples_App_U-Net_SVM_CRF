...
# Initialize tensors for storing images and masks
...
# Function to reshape train images and masks
...
# Function to split images and masks into patches
...
# Function to save patches (unchanged, but handle torch tensors correctly)
...
# Call the functions to process and save your data
